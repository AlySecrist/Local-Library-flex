...
====stretch- include all above plus: <!-- some() -->, every()====

<!-- The project employs at least one helper function, which helps support the tested functions. -->

<!--The project uses at least  two of the following JavaScript features: the ternary operator -->, the spread operator, object shorthand, array or object destructuring,
and <!-- for/in loops. -->
